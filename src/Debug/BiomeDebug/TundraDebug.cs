...
{
    public partial class TundraDebug : Node3D
    {
        ...
        {
            // Create a new SingleBiomeRegionGenerator for Tundra biome
            SingleBiomeRegionGenerator biomeGenerator = new SingleBiomeRegionGenerator(BiomeType.Tundra);
            ...
            GD.Print("Tundra biome debug initialized");
        }
