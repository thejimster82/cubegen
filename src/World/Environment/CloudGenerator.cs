...
public partial class CloudGenerator : Node3D
{
    ...
    [Export] public float CloudScale { get; set; } = 1.0f; // Scale of cloud voxels
    ...
    private void InitializeNoise()
    {
        ...
        _cloudShapeNoise.Frequency = 0.1f;
    ...
    private void GenerateClouds()
    {
        ...
        for (int i = 0; i < CloudCount; i++)
        {
            ...
            // Random cloud size
            int cloudSizeX = _random.Next(8, 20);
            int cloudSizeZ = _random.Next(8, 20);
            int cloudSizeY = _random.Next(3, 6);
