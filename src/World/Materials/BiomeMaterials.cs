...
public static class BiomeMaterials
{
            ...
            foreach (VoxelType voxelType in Enum.GetValues(typeof(VoxelType)))
            {
                ...
                switch (biomeType)
                {
                    ...
                    case BiomeType.Water:
                        SetWaterBiomeColors(material, voxelType);
                        break;
    ...
    private static void SetWaterBiomeColors(StandardMaterial3D material, VoxelType voxelType)
    {
        switch (voxelType)
        {
            case VoxelType.Grass:
                material.AlbedoColor = new Color(0.3f, 0.6f, 0.4f); // Underwater grass
                break;
            case VoxelType.Dirt:
                material.AlbedoColor = new Color(0.4f, 0.35f, 0.3f); // Dark underwater soil
                break;
            case VoxelType.Stone:
                material.AlbedoColor = new Color(0.4f, 0.45f, 0.5f); // Underwater stone
                break;
            case VoxelType.Sand:
                material.AlbedoColor = new Color(0.8f, 0.75f, 0.6f); // Underwater sand
                break;
            case VoxelType.Wood:
                material.AlbedoColor = new Color(0.3f, 0.25f, 0.2f); // Dark waterlogged wood
                break;
            case VoxelType.Leaves:
                material.AlbedoColor = new Color(0.2f, 0.4f, 0.3f); // Dark underwater plants
                break;

            // Decoration types
            case VoxelType.TallGrass:
                material.AlbedoColor = new Color(0.2f, 0.5f, 0.4f); // Underwater seaweed
                break;
            case VoxelType.Flower:
                material.AlbedoColor = new Color(0.5f, 0.3f, 0.6f); // Underwater coral
                break;
            case VoxelType.Mushroom:
                material.AlbedoColor = new Color(0.4f, 0.3f, 0.5f); // Underwater fungus
                break;
            case VoxelType.Rock:
                material.AlbedoColor = new Color(0.5f, 0.55f, 0.6f); // Underwater rock
                break;
            case VoxelType.Stick:
                material.AlbedoColor = new Color(0.35f, 0.3f, 0.25f); // Underwater stick
                break;
            case VoxelType.Seashell:
                material.AlbedoColor = new Color(0.9f, 0.85f, 0.8f); // Seashell
                break;

            case VoxelType.Water:
                material.AlbedoColor = new Color(0.1f, 0.3f, 0.7f); // Deep blue water
                ...
                material.AlbedoColor = new Color(0.1f, 0.3f, 0.7f, 0.7f); // Add alpha for transparency
                break;
            case VoxelType.Snow:
                material.AlbedoColor = new Color(0.8f, 0.85f, 0.9f); // Underwater snow (rare)
                break;
            case VoxelType.Bedrock:
                material.AlbedoColor = new Color(0.2f, 0.25f, 0.3f); // Dark underwater bedrock
                break;
            case VoxelType.Cloud:
                material.AlbedoColor = new Color(0.7f, 0.8f, 0.9f); // Underwater "clouds" (bubbles)
                material.Roughness = 0.9f;
                material.Metallic = 0.0f;
                break;
            case VoxelType.Cactus:
                material.AlbedoColor = new Color(0.3f, 0.5f, 0.4f); // Underwater plant
                break;
            case VoxelType.IceBlock:
                material.AlbedoColor = new Color(0.6f, 0.7f, 0.9f); // Underwater ice
                material.Roughness = 0.1f;
                material.Metallic = 0.1f;
                break;
            case VoxelType.SnowLeaves:
                material.AlbedoColor = new Color(0.5f, 0.6f, 0.7f); // Underwater snow-covered plants
                break;
            default:
                material.AlbedoColor = new Color(0.3f, 0.5f, 0.7f); // Generic underwater color
                break;
        }
    }
