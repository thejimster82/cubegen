...
namespace CubeGen.World.Common
{
    public static class VoxelProperties
    {
        ...
        static VoxelProperties()
        {
            ...
            // Set specific scales
            _voxelScales[VoxelType.TallGrass] = VoxelScale.Quarter;
            _voxelScales[VoxelType.Flower] = VoxelScale.Quarter;
            _voxelScales[VoxelType.Mushroom] = VoxelScale.Quarter;
            _voxelScales[VoxelType.Rock] = VoxelScale.Quarter;
            _voxelScales[VoxelType.Stick] = VoxelScale.Quarter;
            _voxelScales[VoxelType.Seashell] = VoxelScale.Quarter;
        }
