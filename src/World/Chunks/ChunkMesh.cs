        ...
        foreach (var biomeEntry in meshDataByBiomeAndType)
        {
            ...
            foreach (var typeEntry in biomeEntry.Value)
            {
                ...
                try
                {
                    ...
                    {
                        GD.PrintErr($"Failed to get material for biome {biomeType} and voxel type {voxelType} in ChunkMesh");
                ...
                {
                    GD.PrintErr($"Error setting material in ChunkMesh: {ex.Message}");
