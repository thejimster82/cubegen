...
{
    public partial class DesertDebug : Node3D
    {
        ...
        {
            // Create a new SingleBiomeRegionGenerator for Desert biome
            SingleBiomeRegionGenerator biomeGenerator = new SingleBiomeRegionGenerator(BiomeType.Desert);
            ...
            GD.Print("Desert biome debug initialized");
        }
