...
{
    public partial class IslandsDebug : Node3D
    {
        ...
        {
            // Create a new SingleBiomeRegionGenerator for Islands biome
            SingleBiomeRegionGenerator biomeGenerator = new SingleBiomeRegionGenerator(BiomeType.Islands);
            ...
            GD.Print("Islands biome debug initialized");
        }
